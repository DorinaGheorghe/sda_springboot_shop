...
import com.sda.dorinagheorghe.webshop.model.*;
import com.sda.dorinagheorghe.webshop.repository.BillRepository;
import com.sda.dorinagheorghe.webshop.repository.CustomerRepository;
import com.sda.dorinagheorghe.webshop.repository.OrderRepository;
...
public class OrderService {
    ...
    public void save(Customer customer, List<Product> products) {
        ...
        bill.setDueDate(Timestamp.from(Instant.now().plus(Duration.ofDays(7))));//the same, var mai buna
